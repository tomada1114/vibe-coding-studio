...
ドラッグ&ドロップで操作できるAIマインドマップアプリを完成させ、GitHubとVercelで公開してポートフォリオとして活用できるところまで到達します。`,
  features: [
    ...
    {
      title: '初心者も安心の支援',
      description: 'コピペ可能な指示書、つまずきポイントの事前解消、実際の開発画面での丁寧な解説。',
    },
  ],
  projects: [
    {
  ...
  targetAudience: [
    ...
    },
    {
      ...
      points: ['Gemini CLI を使いこなしたい', 'Vibe Coding を実践したい', 'AIの可能性を検証したい'],
    },
    {
    ...
    },
    {
      ...
      points: ['Claude Code や Cursor と比較したい', '無料環境でどこまで出来るか試したい'],
    },
  ],
}
