 ...
 */
export const DEVICON_COLORS: Record<string, { text: string; bg: string; hover: string }> = {
  ...
  python: { text: 'text-blue-600', bg: 'bg-blue-600', hover: 'hover:bg-blue-500' },
  javascript: { text: 'text-yellow-500', bg: 'bg-yellow-500', hover: 'hover:bg-yellow-400' },
  typescript: { text: 'text-blue-600', bg: 'bg-blue-600', hover: 'hover:bg-blue-500' },
  react: { text: 'text-cyan-500', bg: 'bg-cyan-500', hover: 'hover:bg-cyan-400' },
  git: { text: 'text-orange-600', bg: 'bg-orange-600', hover: 'hover:bg-orange-500' },
  terminal: { text: 'text-gray-800', bg: 'bg-gray-800', hover: 'hover:bg-gray-700' },
  docker: { text: 'text-blue-600', bg: 'bg-blue-600', hover: 'hover:bg-blue-500' },
}
