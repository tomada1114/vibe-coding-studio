export function ThemingIcon({ id, color = 'blue' }: { id: string; color?: string }) {
  return (
    <>
      <defs>
      ...
      <g>
        ...
        <circle cx={16} cy={16} r={8} stroke="var(--icon-foreground)" strokeWidth={1.5} fill="none" />
        <path d="M16 8v16" stroke="var(--icon-foreground)" strokeWidth={1.5} />
        <path d="M16 8a8 8 0 010 16" fill="var(--icon-foreground)" fillOpacity={0.3} />
      </g>
    </>
  )
}
