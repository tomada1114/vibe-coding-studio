...
export const COURSE_INFO: Record<string, CourseInfo> = {
  ...
  '6827941': {
    ...
    title: '【Claude Code】FlaskとGeminiで作る Python AI アプリ！実践レベルのAI駆動開発を学ぼう',
  ...
  '6327241': {
    ...
    title: '【RSpec 実践入門】Ruby on Rails 開発者のためのテスト自動化 - 完全ガイド',
  ...
  '6772961': {
    ...
    promotionUrl: 'https://www.udemy.com/course/aws-kiro-sd/?referralCode=14D1CD325DA1F5C54C51',
  },
  // Claude Code × MCP 講座
  '6769253': {
    originalPrice: 10000,
  ...
  '6783611': {
    ...
    promotionUrl: 'https://www.udemy.com/course/draft/6783611/?referralCode=0FA02DD403E254AE48AE',
  },
  ...
  '6801509': {
    ...
    topics: ['codex', 'nextjs'],
    promotionUrl: 'https://www.udemy.com/course/codex-nextjs/?referralCode=F5C07ED4A2914F04D6D2',
  },
}
