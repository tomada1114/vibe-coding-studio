...
import { DocsCareerStructuredData } from "@/components/structured-data/DocsCareerStructuredData"
...
const rubyContent: CourseContent = {
  ...
  title: "Ruby 基礎",
  description:
    "プログラミングの基礎から実践的なスキルまで、体系的に学べる Ruby 学習コンテンツ",
  ...
  features: [
    {
      ...
      description:
        "変数・配列・条件分岐などの基本から、オブジェクト指向プログラミングの本質まで",
    },
    {
      icon: Terminal,
      title: "実践的な開発環境の構築手順",
      description:
        "Mac/Windows両対応の環境構築ガイドと、効率的な開発ツールの活用法",
    },
    {
      icon: Layout,
  ...
  targetAudience: [
    {
      ...
      description:
        "基礎から順を追って学べる構成で、着実にスキルを積み上げられます",
    },
    {
      icon: CodeSquare,
      title: "Ruby on Rails でアプリ開発を目指す方",
      description:
        "Railsを使いこなすための確かな Ruby 基礎力を身につけられます",
    },
    {
      icon: Layers,
  ...
  curriculum: [
    {
      ...
      description:
        "Ruby の概要と特徴を学び、これから始まる学習の全体像をつかみます。",
    },
    {
      title: "【Chapter 2】開発環境構築",
      description:
        "Mac・Windows それぞれの環境に Ruby 開発環境を構築します。<strong>Visual Studio Code</strong> のセットアップから効率的な拡張機能の設定まで、実際の開発環境で学習をスタートできるよう詳しく解説します。",
    },
    {
      title: "【Chapter 3】Ruby プログラミングの基礎",
      description:
        "プログラミングの基本となる<strong>変数、データ型、配列、条件分岐、繰り返し処理</strong>など、Ruby の基礎文法を順序立てて学びます。コードサンプルを通して実行結果を確認しながら着実に理解を深めます。",
    },
    {
      title: "【Chapter 4】メソッドによるコードの体系化",
      description:
        "コードを整理して再利用性を高める<strong>「メソッド」</strong>の概念と実装方法を学びます。シンプルなメソッドから始め、引数の扱いや例外処理などの応用まで段階的に習得できます。",
    },
    {
      title: "【Chapter 5】オブジェクト指向設計の実践",
      description:
        "Ruby の中核となる<strong>「オブジェクト指向」</strong>について学びます。<strong>クラスとインスタンス、継承、モジュール</strong>などの概念を具体的なコード例と共に理解できるよう解説します。",
    },
    {
      title: "【Chapter 6】Rails 開発でよく使う Ruby のメソッド",
      description:
        "Ruby on Rails 開発で頻繁に使われる<strong>メソッドやテクニック</strong>を紹介します。<strong>配列操作、文字列加工、日付処理</strong>など、実務ですぐに役立つ知識をサンプルコードと共に解説します。",
    },
  ],
...
export default function RubyCurriculumPage() {
  return (
    <>
      ...
      <Curriculum
        slug={slug}
        courseContent={rubyContent}
        themeColors={rubyThemeColors}
      />
    </>
  )
}
