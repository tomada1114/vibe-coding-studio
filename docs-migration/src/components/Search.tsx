  ...
  return (
    ...
    >
      <div
        id={`${id}-title`}
        aria-hidden="true"
        className="text-sm text-slate-700 group-aria-selected:text-sky-600 dark:text-slate-100 dark:group-aria-selected:text-sky-400"
      >
      ...
      {hierarchy.length > 0 && (
        <div
          id={`${id}-hierarchy`}
          aria-hidden="true"
          className="mt-0.5 truncate text-xs whitespace-nowrap text-slate-700 dark:text-slate-200"
        >
...
function SearchResults({
  ...
  if (collection.items.length === 0) {
    return (
      <p className="px-4 py-8 text-center text-sm text-slate-700 dark:text-slate-200">
  ...
  return (
    <>
      ...
      >
        ...
        <span className="sr-only md:not-sr-only md:ml-2 md:text-slate-500 md:dark:text-slate-200">
          Search docs
        </span>
        {modifierKey && (
